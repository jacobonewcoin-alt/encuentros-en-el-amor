...
import { testimonios, palabrasRetiro } from "@/lib/data";
...
export default function TestimoniosPage() {
  ...
  return (
    <>
      ...
      {/* Testimonios destacados — arcilla según guía de marca */}
      ...
      {/* CTA — salvia: mensaje positivo "¿sientes que esto es para ti?" */}
